...
export default function QuestTracker() {
  ...
  const updateTaskProgress = (taskId, delta) => {
    ...
    // recompute all-complete for today with the new log (only tasks scheduled today count)
    const sumTarget = scheduledToday.reduce((s, t) => s + t.target, 0);
    const sumCurrent = scheduledToday.reduce(
